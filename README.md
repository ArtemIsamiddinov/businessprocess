...
Легковесная и гибкая библиотека для создание бизнесс процессов на вашей платформе.
Проект использует строгую типизацию, соответствует стандарту PSR-4, PSR-12 а также интегрирован с диспетчером событий
PSR-14.
